...
- Sender: create, destroy, acquire_writable_frame, commit_frame, get_info, publish_texture, publish_gl_texture
- Receiver: create, destroy, acquire_frame, get_connected_info
- Frame: release, get_info, lock_pixels, unlock_pixels, lock_writable_pixels, unlock_writable_pixels, copy_to_gl_texture
